...
namespace XRMultiplayer
{
	...
	public class XRHandPoseReplicator : NetworkBehaviour
	{
		...
		{
			if(m_LeftHandOrigin == null || m_RightHandOrigin == null)
			{
				return;
			}
			
			m_leftHand.SetPositionAndRotation(m_LeftHandOrigin.position, m_LeftHandOrigin.rotation);
			m_rightHand.SetPositionAndRotation(m_RightHandOrigin.position, m_RightHandOrigin.rotation);
		}
